...
import { ShoppingCart, DollarSign, CreditCard, RotateCcw, Clock, Loader2 } from 'lucide-react';
...
export default function PurchasesSummary() {
  ...
  const tiles = [
    ...
    { label: 'On Hold',           key: 'hold',    icon: Clock,        color: 'text-gray-600',   bg: 'bg-gray-50',   border: 'border-gray-200' },
  ];
